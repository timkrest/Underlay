...
Библиотека блюра вместо `Modifier.blur()` дала то же самое. Переставил модификаторы местами,
обернул всё в `Box`, перенёс модификатор на родителя. Ничего не поменялось.
